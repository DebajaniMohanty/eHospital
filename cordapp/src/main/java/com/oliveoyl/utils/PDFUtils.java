...
public class PDFUtils {
    ...
    public static void generatePDFCertificate(CryptoFishy cryptoFishy, String fileName, String regulatoryBodyName) {
        ...
        try {
            ...
            String description = "Certificate allowing to fish " + cryptoFishy.getQuantity() + "units of " + cryptoFishy.getType() + " in " + cryptoFishy.getLocation()  + " .";
    ...
    public static CryptoFishyCertificateInfo getDocumentInfo(File file) {
        ...
        try {
            ...
            certificateInfo.setType(insertedInfo.getCustomMetadataValue("Quantity"));
